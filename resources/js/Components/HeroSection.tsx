        ...
        <div className="relative h-screen w-full overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col justify-center items-start px-6 md:px-16 max-w-7xl mx-auto">
                ...
                <div className="flex flex-wrap gap-4 w-full">
                    <Button variant="default" size="lg" className="flex-grow bg-white text-black hover:bg-gray-200">
                        SHOP WOMEN
                    </Button>
                    <Button variant="outline" size="lg" className="flex-grow text-black bg-gray-100 hover:bg-gray-200">
                        SHOP MEN
                    </Button>
                    <Button variant="outline" size="lg" className="flex-grow text-black bg-gray-100 hover:bg-gray-200">
                        SHOP COLLECTIONS
