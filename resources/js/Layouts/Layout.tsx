        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:underline">Submit a Fake</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:underline">Glide Central</a></li>
              <li><a href="#" className="hover:underline">About Us</a></li>
              <li><a href="#" className="hover:underline">Careers</a></li>
              <li><a href="#" className="hover:underline">Student Discount</a></li>
              <li><a href="#" className="hover:underline">Factory List</a></li>
            </ul>
          </div>
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-gray-100 p-4 flex flex-col items-center justify-center">
                <img src="/api/placeholder/40/40" alt="Central" className="mb-2" />
                <span className="text-xs font-semibold">BLOG</span>
              </div>
              <div className="bg-gray-100 p-4 flex flex-col items-center justify-center">
                <img src="/api/placeholder/40/40" alt="Email" className="mb-2" />
                <span className="text-xs font-semibold">EMAIL SIGN UP</span>
              </div>
              <div className="bg-gray-100 p-4 flex flex-col items-center justify-center">
                <img src="/api/placeholder/40/40" alt="Training" className="mb-2" />
                <span className="text-xs font-semibold">GLIDE TRAINING</span>
              </div>
            </div>
          </div>
        </div>
